...
- Branch naming: `tsk/{task-id}` (where task-id is an 8-character unique identifier generated by nanoid)
...
- Tasks create branches with unique 8-character IDs: `tsk/a1b2c3d4`
