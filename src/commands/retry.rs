...
mod tests {
    ...
    async fn setup_test_environment_with_completed_tasks(
        ...
        for (i, task_id) in task_ids.iter().enumerate() {
            ...
            tasks_json.push(format!(
                r#"{{"id":"{}","repo_root":"{}","name":"test-task-{}","task_type":"feat","instructions_file":"{}","agent":"claude-code","timeout":30,"status":"COMPLETE","created_at":"2024-01-01T00:00:00Z","started_at":"2024-01-01T00:30:00Z","completed_at":"2024-01-01T01:00:00Z","branch_name":"tsk/{}","error_message":null,"source_commit":"abc123","tech_stack":"default","project":"default","copied_repo_path":"{}"}}"#,
                task_id,
    ...
    async fn test_retry_queued_task_fails() {
        ...
        let task_json = format!(
            r#"[{{"id":"{}","repo_root":"{}","name":"queued-task","task_type":"feat","instructions_file":"instructions.md","agent":"claude-code","timeout":30,"status":"QUEUED","created_at":"2024-01-01T00:00:00Z","started_at":null,"completed_at":null,"branch_name":"tsk/{}","error_message":null,"source_commit":"abc123","tech_stack":"default","project":"default","copied_repo_path":"{}"}}]"#,
            task_id,
            repo_root.to_string_lossy(),
            task_id,
            task_dir_path.to_string_lossy()
