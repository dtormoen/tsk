...
mod tests {
    ...
    async fn setup_test_environment_with_tasks(
        ...
        for i in 0..task_count {
            ...
            tasks_json.push(format!(
                r#"{{"id":"{}","repo_root":"{}","name":"task-{}","task_type":"feat","instructions_file":"{}","agent":"claude-code","timeout":30,"status":"{}","created_at":"2024-01-01T12:{:02}:00Z","started_at":null,"completed_at":null,"branch_name":"tsk/feat/task-{}/{}","error_message":null,"source_commit":"abc123","tech_stack":"default","project":"default","copied_repo_path":"{}"}}"#,
                task_id,
    ...
    #[tokio::test]
    async fn test_list_command_outside_repository() {
        ...
        // Create test environment with tasks
        let (ctx, _xdg, _temp_dir2) = setup_test_environment_with_tasks(3).await.unwrap();
        ...
        // The command should succeed even outside a repository
        assert!(result.is_ok());
    }
